...
class WebNLG(Dataset):
    def __init__(self, tokenizer, data_dir, max_source_length,
        ...
        dataset_kwargs.update({"add_prefix_space": True})
...
class BARTFineTuner(pl.LightningModule):
    ...
    def __init__(self, hparams):
        ...
        self.model = BartForConditionalGeneration.from_pretrained(self.hparams.model_name_or_path, config=self.config)
        self.tokenizer = BartTokenizer.from_pretrained(self.hparams.model_name_or_path)
...
if __name__ == "__main__":
    ...
    parser = BARTFineTuner.add_model_specific_args(parser, os.getcwd())
